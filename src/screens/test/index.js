...
import IconAni from "../homeCare/IconAni";
import IconWithoutAni from "../homeCare/IconWithoutAni";
import WaveAni from "../homeCare/WaveAni";
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Svg height="100%" width="100%" viewBox="0 0 100 19">
                        ...
                        <WaveAni a1={80} a2={13} delay={0} color={COLOR.color_5}/>
                        <WaveAni a1={100} a2={10} delay={300} color={COLOR.color_2}/>
                        <WaveAni a1={120} a2={7} delay={800} color={COLOR.color_1}/>
                    </Svg>
                </View>
